#my default list of models to use 
...
#for this tutorial lets just use 2 models 
m_list_mask=("ACCESS-CM2,r1i1p1f1" "CanESM5,r1i1p1f1")

# Data at the IPSL node is located at /bdd 
# CMIP6 data is in /bdd/CMIP6/CMIP/
# eg. 
...
for gcm in "${m_list_mask[@]}"; do
   ...
   # printf "%s %s\n" "${name}" "${url}"
    echo "${gcm}" "${iter}"
    #ls /bdd/CMIP6/CMIP/*/${gcm}/${scen}/${iter}/day/${var}/*/latest/${var}*
    find /bdd/CMIP6/CMIP/*/${gcm}/${scen}/${iter}/day/${var}/*/latest/${var}*  -name "${var}_*" > ${var}_${scen}_${gcm}.txt
